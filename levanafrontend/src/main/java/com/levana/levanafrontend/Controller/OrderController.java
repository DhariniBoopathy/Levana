...
import com.levana.levanabackend.DAL.AddressDAO;
import com.levana.levanabackend.DAL.CartDAO;
import com.levana.levanabackend.DAL.OrderDAO;
...
public class OrderController {
	...
	String viewOrders(Model m, HttpSession session) {
		m.addAttribute("orderlist",
				orderdao.ViewOrder(Integer.parseInt(session.getAttribute("usercartid").toString())));
