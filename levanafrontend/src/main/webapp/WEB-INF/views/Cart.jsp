...
<div class="container">
	<c:if test="${empty(cartlist)}">
		...
		<a href="${contextRoot}/viewallproducts" class="btn button"><i
				...
				<c:forEach items="${cartlist}" var="l">
					<tr>
						...
						<td class="actions" data-th="">
							...
							</button> <a href="deleteitem?itemid=${l.itemid}"
							class="btn btn-danger btn-sm"> <i class="fa fa-trash-o"></i>
								<a href="incqty?itemid=${l.itemid}" class="btn btn-info btn-sm">
									+ </a> <a href="decqty?itemid=${l.itemid}"
